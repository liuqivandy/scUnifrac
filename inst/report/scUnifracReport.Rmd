...
_Command_: 
```
scUnifrac(data1=colon1,data2=pan1,genenum=500,ncluster=10,nDim=4, samplenames=c("Colon","Pan"))
```
...
subRmd<-paste0(output_dir, "/subpopulation.rmd")
fileContent<-c("# Subpopulation View \n")
for (i in 1:length(plotData$diffnodes)){
  nodeName<-plotData$diffnodes[i]
  commonContent<-paste0("  clustertext<-paste(\"Subpopulation ", nodeName, "\",paste(count.table[,", nodeName, "],collapse=\":\"),sep=\",\")\n", "  nodeName<-plotData$diffnodes[", i, "]\n")

  fileContent<-c(fileContent, paste0("* The cell subpopulation ", nodeName, "\n"))
  
  fileContent<-c(fileContent, paste0("```{r plotMarkergene", nodeName, ", eval=DISPLAY_FIGURE, echo=FALSE, warning=FALSE, message=FALSE, results='asis', fig.align=\"center\", fig.cap=figRef(\"", "plotMarkGene", nodeName, "\", \"Heatmap of gene expressions that mark the cell subpopulation ", nodeName, "\"), fig.height=6}"))
  ...
  fileContent<-c(fileContent, paste0("```{r plotCelltype", nodeName, ", eval=DISPLAY_FIGURE, echo=FALSE, warning=FALSE, message=FALSE, results='asis', fig.align=\"center\", fig.cap=figRef(\"", "plotCelltype", nodeName, "\", \"Predicted cell types of the cell subpopulation ", nodeName, "\"), fig.height=6}"))
