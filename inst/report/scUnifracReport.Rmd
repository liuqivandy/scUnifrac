...
for (i in 1:length(plotData$diffnodes)){
  ...
  fileContent<-c(fileContent, paste0("```{r plotMarkergene", nodeName, ", eval=DISPLAY_FIGURE, echo=FALSE, warning=FALSE, message=FALSE, results='asis', fig.align=\"center\", fig.cap=figRef(\"", "plotMarkGene", nodeName, "\", \"Heatmap of gene expressions that mark the cell subpopulation ", nodeName, "\"), fig.height=7}"))
  ...
  fileContent<-c(fileContent, paste0("```{r plotCelltype", nodeName, ", eval=DISPLAY_FIGURE, echo=FALSE, warning=FALSE, message=FALSE, results='asis', fig.align=\"center\", fig.cap=figRef(\"", "plotCelltype", nodeName, "\", \"Predicted cell types of the cell subpopulation ", nodeName, "\"), fig.height=7}"))
