...
<br>
Besides calculating the distance and the pvalue, scUnifrac will generate a report ([a report example])(https://rawgit.com/wiki/liuqivandy/scUnifrac/scUnifrac_colon_pan.print.html) figures illustrating subpopulation structure, marker genes and predicted cell types in each subpopulation. 
